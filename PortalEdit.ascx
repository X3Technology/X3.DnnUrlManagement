        ...
        <div>
            ...
            <div class="dnnClear">
                <telerik:RadGrid ID="gvCustomUrls" runat="server" AutoGenerateColumns="False"
                    OnNeedDataSource="gvCustomUrls_NeedDataSource" OnItemDataBound="gvCustomUrls_ItemDataBound" OnDeleteCommand="gvCustomUrls_DeleteCommand"
                    ...
                    <MasterTableView DataKeyNames="SeqNum" CommandItemDisplay="Top" InsertItemDisplay="Top" EditMode="InPlace">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="PortalAlias" UniqueName="PortalAliasId">
                                <ItemTemplate>
                                    <asp:DropDownList runat="server" ID="ddlPortalAliasId" Enabled="false" />
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Portal Alias Usage" UniqueName="PortalAliasUsage">
                                <ItemTemplate>
                                    <asp:DropDownList runat="server" ID="ddlPortalAliasUsage" Enabled="false">
                                        <asp:ListItem Value="0" Text="Default" />
                                        <asp:ListItem Value="1" Text="Child Pages Inherit" />
                                        <asp:ListItem Value="2" Text="Child Pages Do Not Inherit" />
                                        <asp:ListItem Value="3" Text="Inherited From Parent" />
                                    </asp:DropDownList>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:DropDownList runat="server" ID="ddlPortalAliasUsage">
                                        <asp:ListItem Value="0" Text="Default" />
                                        <asp:ListItem Value="1" Text="Child Pages Inherit" />
                                        <asp:ListItem Value="2" Text="Child Pages Do Not Inherit" />
                                        <asp:ListItem Value="3" Text="Inherited From Parent" />
                            ...
                            <telerik:GridTemplateColumn HeaderText="URL Type">
                                <ItemTemplate>
                                    <asp:DropDownList runat="server" ID="ddlHttpStatus" Enabled="false">
